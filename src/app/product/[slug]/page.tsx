...
/**
 * Dynamic Product Detail Page utilizing Incremental Static Regeneration (ISR).
 * Serves as a visual scent storytelling showcase for specific Scandalea fragrances.
 */
        ...
        <main className="min-h-screen bg-black text-white pb-20">
            ...
            <div className="flex flex-col lg:flex-row min-h-screen">
                ...
                <div className="w-full lg:w-1/2 lg:ml-[50%] px-6 py-20 lg:p-32 flex flex-col gap-12 bg-black z-10">
                    ...
                    {/* Footer Link */}
                    <div className="pt-20">
                        <Link href="/#collection" className="text-xs uppercase tracking-widest border-b border-white pb-1 hover:text-scandalea-gold hover:border-scandalea-gold transition-colors">
                            ← Back to Collection
                        </Link>
                    </div>
